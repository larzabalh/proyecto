...
<div class="container box">
   <h1 align="center">CUENTAS CORRIENTES DISPONIBILIDADES</h1><br />   
          ...
          <form name="" id="form" method="POST">
            ...
            <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
              ...
              <select class="form-control selectpicker" data-live-search="true" name="periodo" id="cliente">
                  @foreach ($disponibilidad_id as $value)
...
<script src="{{ asset('/js/registros/CtaCte/disponibilidades.js')}}"></script>
